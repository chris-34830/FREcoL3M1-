Le modèle de Solow avec croissance démographique et le modèle de Malthus se rejoignent dans leur capacité d'expliquer comment la population affecte le niveau de revenu par habitant.
