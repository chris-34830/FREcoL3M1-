## Exercice 1 Role des soldes intermédiaires de gestion
...
### Etudier les ratios de profitabilité et de rentabilité économique
...
|---|---|---|---|---|
| **Actifs** |  |  |  |  |
| Ratio des immobilisations incorporelles |  | 0 | 0 | Absence d'immobilisation incorporelles |
| Ratio des immobilisations corporelles |  | 16.22% | 14.46% | Réduction relative des IC par rapport au total des AC<br>Baisse lié à l'augmentation des AC. Positif |
| Ratio des immobilisations financières |  | 0.014%  | 0.011% | Faible investissement financiers de l'entreprise<br>Peu important, l'entreprise n'a pas pour politique l'investissement financier |
| Ratio des valeurs d'exploitations |  | 38.64% | 36.87% | Poids de mes stocks moins importants dans mon AC<br>Positif si rentabilité inchangée |
| Ratio des créances clients |  | 26.36% | 34.23% | Augmentation du recours au créances clients<br>Positif si lié à l'augmentation des ventes (regarder CA, délai de rotation des créances clients etc) |
| Ratio des autres actifs |  | 18.77% | 8.41% | Réduction du poids des actifs non productifs |
| **Passif** |  |  |  |  |
| Ratio d'autonomie globale |  | 6.93% | 10.44% | Entreprise moins dépendante des dettes pour le financement de ses activités |
| Ratio des DMLT |  | 18.7% | 11.56% | Pareil qu'au dessus |
| Ratio des fournisseurs et effets commerciaux |  | 10.54% | 23.04% | Vérifier le délai de rotation pour statuer. Si il a augmenté alors négatif car risque de problème de trésorerie<br>Si plus d'achat ou meilleurs utilisations des dettes fournisseurs alors positif |
| Ratio des dettes bancaires à CT |  | 26.4% | 24.55% | Moins dépendante des dettes bancaires à court terme |
| Ratio des autres dettes à CT |  | 34.44% | 30.41% | Réduction des dettes à CT, meilleurs trésorerie |
Pré-Conclusion I :
