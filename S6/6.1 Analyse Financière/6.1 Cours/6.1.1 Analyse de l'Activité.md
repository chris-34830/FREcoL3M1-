	...
	<body>
		<table>
			...
			<tr>
				...
				<td rowspan =3> <br> <br> =Achat de MP + Var. Stock de Mp + Autre achat et charges ext
			 </td>
			</tr>
			<tr><tr>
			...
			<tr>
				...
				<td rowspan =3> <br> en produits d'exploitation <br> en produits d'Exploitation <br> en charges d'exploitations <br> en charges d'exploitations
			 </td>
			</tr>
			<tr><tr>
